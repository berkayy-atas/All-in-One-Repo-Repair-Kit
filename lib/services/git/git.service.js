...
class GitService extends base_service_1.BaseService {
    ...
    async pushMirror(repoPath) {
        ...
        try {
            ...
            await (0, exec_1.exec)('git', ['push', '--mirror', '--force', 'origin'], { cwd: repoPath });
    ...
    async pushAllBranches(repoPath) {
        ...
        try {
            ...
            for (const branch of branches) {
                ...
                await (0, exec_1.exec)('git', ['push', 'origin', branch, '--force'], { cwd: repoPath });
            }
            this.logger.info('Pushing all tags...');
            await (0, exec_1.exec)('git', ['push', 'origin', '--tags', '--force'], { cwd: repoPath });
